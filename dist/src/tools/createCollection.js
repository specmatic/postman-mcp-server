        ...
        item: z.array(z
            ...
            event: z
                ...
                listen: z
                    ...
                    .describe('Can be set to `test` or `prerequest` for test scripts or pre-request scripts respectively.'),
                script: z
                    .object({
                    type: z
                        .string()
            ...
            request: z
                ...
                body: z
                    ...
                    .describe('Information about the collection\'s request body. To set this to "none", pass an empty object.')
                    .optional(),
            })
            ...
            protocolProfileBehavior: z
                ...
                disableBodyPruning: z
                    .boolean()
                    .describe('If true, disables request body pruning for the GET, COPY, HEAD, PURGE, and UNLOCK methods.')
                    .optional(),
                disableUrlEncoding: z
                    .boolean()
                    .describe('If true, disables the percent encoding of auth, path, query, and fragment URL segments.')
                    .optional(),
                ...
                followOriginalHttpMethod: z
                    .boolean()
                    .describe('If true, redirects with the original HTTP method. Redirects with the GET HTTP method by default.')
                    .optional(),
                followAuthorizationHeader: z
                    .boolean()
                    .describe('If true, retains the `authorization` header when a redirect happens to a different hostname.')
                    .optional(),
                protocolVersion: z
                    .enum(['http1', 'http2', 'auto'])
                    .describe('The HTTP protocol version to use. Supports the `http1`, `http2`, and `auto` values.')
                    .optional(),
                ...
                tlsPreferServerCiphers: z
                    .boolean()
                    .describe("If true, uses the server's cipher suite order instead of the client's during negotiation.")
                    .optional(),
                ...
                tlsCipherSelection: z
                    .array(z.string())
                    .describe('The order of cipher suites that the SSL server profile uses to establish a secure connection.')
                    .optional(),
            })
