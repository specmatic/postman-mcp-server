...
export const method = 'transfer-collection-responses';
...
export const parameters = z.object({
    ...
    target: z
        ...
        model: z
            ...
            .describe('The collection, folder, or request that the items will be transferred to. For response transfers, use the `request` value.'),
    })
    ...
    location: z
        ...
        model: z
            .string()
            .nullable()
            .describe('For `before` or `after` positions, the type of item (model) that the transferred item will be positioned by. One of: `folder`, `request`, or `response.`\n')
            .optional(),
        position: z
